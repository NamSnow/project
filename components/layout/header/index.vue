<template>
  <div class="relative mx-auto h-auto w-full max-w-full min-h-screen">
    <div class="absolute inset-0 z-0">
      ...
      ></div>
      <div
        class="absolute inset-0 bg-[#0a2c0f] opacity-70 z-10 w-full h-full"
      ></div>
    </div>
    ...
    >
      ...
      >
        ...
        <div class="flex">
          ...
          <a
            href=""
            class="text-white h-[50px] items-center lg:flex hidden pl-7.5"
          >
            <button
              class="px-7.5 cursor-pointer bg-[#d1a132] rounded-full h-full hover:bg-white hover:text-black font-bold"
            >
              Shop Now
            </button>
            <button
              class="bg-[#FFFFFF1A] w-[50px] h-full rounded-full cursor-pointer transform -rotate-45 hover:rotate-0"
            >
    ...
    <div
      class="relative z-20 flex lg:flex-row flex-col text-white max-w-[1300px] mx-auto p-2.5 mt-20 pb-20 items-center flex-1"
    >
      <div class="lg:w-1/2 flex flex-col gap-4 w-full">
        <div class="flex items-center">
          <div class="w-2 h-2 mr-4 bg-[#D1A132] rounded-full"></div>
          <div class="text-lg">Discover The Power Of Premium</div>
        </div>
        <div class="text-6xl">
          Pure drops perfect precision <span>care you can trust</span>.
        </div>
        <p class="text-base">
        ...
        <div class="flex gap-10">
          <a href="" class="text-white h-[50px] items-center lg:flex hidden">
            <button
              class="px-7.5 cursor-pointer bg-[#d1a132] rounded-full h-full hover:bg-white hover:text-black font-bold"
            >
              Purchase Now
          ...
          <div class="flex gap-4">
            ...
            <div>
              ...
              <div class="hover:text-[#D1A132] cursor-pointer">
                +91 - 123 468 963
              </div>
            </div>
          </div>
